  ...
  map.on('load', function (e) {
    ...
    map.on('click', function (e) {
      ...
      function createPopUp(currentFeature) {
        ...
        var popup = new mapboxgl.Popup({ closeOnClick: false }).setLngLat(currentFeature.geometry.coordinates).setHTML('<a href="/stores/' + currentFeature.properties.slug + '"><h4 style="font-size: 2rem;">' + currentFeature.properties.name + '</h4></a>').addTo(map);
      }
    });
  });
}
