...
exports.getStores = async (req, res) => {
  ...
  if (!stores.length && skip) {
    req.flash("info", `Hey! There is no page ${page}. Redirected you to page ${pages}`);
    res.redirect(`/stores/page/${pages}`);
  }

  res.render("stores", { title: "Stores", page, count, stores, pages });
};
...
exports.updateStore = async (req, res) => {
  ...
  req.flash(
    "success",
    `Successfully updated <strong>${store.name}</strong>. <a href="/stores/${store.slug}">View Store`
  );
